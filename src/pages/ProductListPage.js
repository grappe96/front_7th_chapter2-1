 ...
 * 상품 목록 페이지 컴포넌트
 */
export function ProductListPageLoading() {
  const mainContent = `
...
export function ProductListPageLoaded() {
  const mainContent = `
    <main class="max-w-md mx-auto px-4 py-4">
        <!-- 검색 및 필터 -->
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-4">
...
export function ProductListPageCategory1Depth() {
  return `
    <main class="max-w-md mx-auto px-4 py-4">
      <!-- 검색 및 필터 -->
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-4">
...
export function ProductListPageCategory2Depth() {
  return `
    <main class="max-w-md mx-auto px-4 py-4">
      <!-- 검색 및 필터 -->
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-4">
